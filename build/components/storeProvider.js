...
const storeProvider = (extraProps = () => ({})) => Component => {
  ...
  return _temp2 = _class = class extends _react2.default.PureComponent {
    constructor(...args) {
      ...
      return _temp = super(...args), this.usedState = () => {
        return extraProps(this.context.store, this.props);
      }, this.state = this.usedState(), this.onStoreChange = () => {
  ...
  }, _class.displayName = `${Component.name}Container`, _class.contextTypes = { store: _propTypes2.default.object }, _temp2;
};
